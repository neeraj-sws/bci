    ...
    <div id="pdf" class="page">
        ...
        <table class="items-table">
            <thead>
                <tr>
                    <th class="col-no">#</th>
                    <th>{{ \App\Helpers\SettingHelper::getColoumName('items', $invoice['company_id']) ?? 'Item' }}
                    </th>
        ...
        <div class="totals">
            @if ($invoice['sub_amount'] && $invoice['discount_amount'])
                <div class="row total-payable">
                    ...
                    <div class="amount">{{ \App\Helpers\SettingHelper::formatCurrency($invoice['sub_amount'] ?? 0) }}
            ...
            <div class="row total-payable total-payable-final">
                ...
                <div class="amount">
                    {{ \App\Helpers\SettingHelper::formatCurrency($invoice['amount'], \App\Helpers\SettingHelper::getGenrealSettings('number_format', $invoice['company_id'])) }}
                    &nbsp;{{ $invoice['currency_label'] }}</div>
            </div>
        </div>
