<div class="container my-4">
    ...
    <form wire:submit.prevent="save" class="radius12 bg-white settingforms">
        <div class="row g-4">
            ...
            <div class="mb-1">
                <label for="title" class="form-label">Proforma Invoice Title <span
                        class="text-danger">*</span></label>
                <input type="text" class="form-control @error('pr_invoice_title') is-invalid @enderror"
                    wire:model="pr_invoice_title" placeholder="Invoice Title">
                @error('pr_invoice_title')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
