            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <label for="title" class="form-label">Category Name <span
                            ...
                            <div class="col">
                                <div class="form-group my-3">
                                    <label for="title" class="form-label">Tour Related </label>
                                    <select id="filter_category" class="form-select" wire:model='is_tour'
                                        placeholder="Select Category">
                    ...
                    <div class="table-responsive ecs-table">
                        <table class="table">
                            <thead class="lightgradient">
                                <tr>
                                    <th class="width60">#</th>
                                    <th wire:click="sortby('name')" style="cursor: pointer;" >Category Name
                                         @if ($sortBy === 'name')
                                            <i
