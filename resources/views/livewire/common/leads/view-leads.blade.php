								...
								<div class="d-flex  justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										<div class="avatar avatar-xxl avatar-rounded border border-warning bg-soft-warning me-3 flex-shrink-0">
											<h6 class="mb-0 text-warning">{{ substr(trim($leadData->tourist->primary_contact ?? ""), 0, 1) }}</h6>
										
										</div>
											
										<div>
											<h5 class="mb-1 fw-bold"><span style="color:{{ $leadData->type->color }}"><i class="bx bxs-circle me-1"></i></span>{{ $leadData->tourist->primary_contact ?? ""}} 
											@can('leads manage')
