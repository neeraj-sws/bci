   ...
   <div class="col-12">
       <ul class="nav nav-tabs nav-primary " role="tablist">
           <li class="nav-item me-3">
               <a href="{{ route('common.leads-pipeline') }}"
                   class="nav-link p-2 @if ($pageTitle == 'Lead Type') active @endif">
                   <i class="ti ti-settings-cog me-2"></i>Leads Type
               </a>
           </li>
           <li class="nav-item me-3 d-none">
               <a href="{{ route('common.leads-status') }}"
                   class="nav-link p-2 @if ($pageTitle == 'Lead Status') active @endif">
                   <i class="ti ti-world-cog me-2"></i>Leads Status
               </a>
           </li>
           <li class="nav-item me-3">
               <a href="{{ route('common.leads-stages') }}"
                   class="nav-link p-2 @if ($pageTitle == 'Lead Stages') active @endif">
                   <i class="ti ti-apps me-2"></i>Leads Stage
               </a>
           </li>
           <li class="nav-item me-3">
               <a href="{{ route('common.leads-source') }}"
                   class="nav-link p-2 @if ($pageTitle == 'Leads Source') active @endif">
