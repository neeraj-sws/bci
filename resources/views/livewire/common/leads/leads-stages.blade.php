...
<div class="row g-4">
    ...
    <div class="row g-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <label for="title" class="form-label">Stage Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control text-capitalize @error('name') is-invalid @enderror"
                                wire:model="name" placeholder="Stage name">
                            @error('name')
        ...
        <!-- Table Card -->
        <div class="@can('lead-stages manage') col-md-7 @else col-md-12 @endcan">
            <div class="card">
