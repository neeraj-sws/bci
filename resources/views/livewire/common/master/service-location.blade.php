<div class="container mt-sm-0 mt-3" id="amanity">
    ...
    <div class="row g-4">
        <!-- Form Card -->
        @can('vendor-service-locations manage')
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <label for="title" class="form-label">Location Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="text-capitalize form-control @error('name') is-invalid @enderror"
                                wire:model="name" placeholder="Location name">
                            @error('name')
        ...
        <!-- Table Card -->
        <div class="@can('vendor-service-locations manage') col-md-7 @else col-md-12 @endcan">
            <div class="card">
                    ...
                    <div class="table-responsive ecs-table">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Service Location's found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
