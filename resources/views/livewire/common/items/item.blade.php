                    ...
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="Item Name" class="form-control @error('name') is-invalid @enderror"
                                    wire:model="name">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="SKU" class="form-control @error('sku') is-invalid @enderror"
                                    wire:model="sku" >
                                @error('sku')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="Rate" class="form-control @error('rate') is-invalid @enderror"
                                    wire:model="rate" >
                                @error('rate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="UNIT" class="form-control @error('unit') is-invalid @enderror"
                                    wire:model="unit" >
                                @error('unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    <label for="title" class="form-label">Tax <span class="text-danger">*</span></label>
                                    <select id="tax_id" class="form-select select2" wire:model="tax_id"
                                        placeholder="Tax">
                                        <option value=""></option>
                                        @foreach ($taxes as $id => $tax_name)
                                            <option value="{{ $id }}" @if ($tax_id ===  $id) selected @endif>{{ $tax_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('tax_id')
