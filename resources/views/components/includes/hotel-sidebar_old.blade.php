 <div class="sidebar-wrapper" data-simplebar="init" style="background: linear-gradient(135deg, #000000 0%, #764ba2 100%); max-height: 100vh; overflow-y: auto;">
                            ...
                            {{-- <li class="mb-2">
                             ...
                             <li class="mb-2">
                                 <a href="{{ route('common.room-category-rates') }}" class="text-white"
                                     ...
                                     <span style="margin-left: 10px;">Room Category Rates</span>
                                 </a>
                             </li>
                           ...
                           {{--  <li class="mb-2">
                             ...
                             <li class="mb-2">
                                 <a href="{{ route('common.peak-date-price') }}" class="text-white"
                                     ...
                                     <span style="margin-left: 10px;">Peak Dates Pricing</span>
                                 </a>
                             </li>
