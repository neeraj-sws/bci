...
use App\Models\RateTypes as Model;
...
class RateType extends Component
{
    ...
    public $pageTitle = 'Rate Types';

    public $model = Model::class;
    public $view = 'livewire.common.hotel-master.rate-type';
    ...
    public function rules()
    {
        ...
        return [
            'title' => $this->isEditing
                ? 'required|string|max:255|unique:' . $table . ',title,' . $this->itemId . ',rate_type_id'
